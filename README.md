...
*Opportunity*
Because everyone who finds vulnerabilities is compensated from the pool, C4 presents a great way for beginners to get compensated for their time learning how to hunt for smart contract exploits, to learn from other researchers, and to build a name and reputation within the community as their skills grow.
