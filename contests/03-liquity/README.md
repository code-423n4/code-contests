# Code Contest: Liquity Core Contracts
...
**NOTE:** This is our full system summary, however since the `StabilityPool.sol` contract is excluded from this contest, the testing and deployment sections will not be relevant and the wardens will likely focus on manual review.
...
The development branch with the current system code is `main`.  The `master` branch is quite out of date.
...
PDFs of these can be found in https://github.com/liquity/liquity/tree/master/papers
